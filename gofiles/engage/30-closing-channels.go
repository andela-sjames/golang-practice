...
func main() {
	fmt.Println("here we discuss go closing channels")
	...
	*/
	...
	/*
	   ...
	   In this special 2-value form of receive, the more value will be false if jobs has been
	   closed and all values in the channel have already been received. We use this to notify
